...
2. **Pick your Cursor version** – go into the matching folder (e.g. `2.7.0-pre.35.patch.0\`, `2.7.0-pre.27.patch.0\`, `2.6.13.patch.0\`, `2.6.8.patch.0\`, or `2.5.26\`)
...
| ------------ | ----------------------------- | -------- |
| 2.7.0-pre.35 | `2.7.0-pre.35.patch.0/`       | Tested ✅ |
