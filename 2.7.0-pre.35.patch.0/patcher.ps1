<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.7.0-pre.35 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 2.7.0-pre.35.
    Pre.35 variables: n2w (2 layouts), lh (clear), m4/a2w (opener), pL (cmd), Ei (StorageScope).
#>
...
# 2.7.0-pre.35: n2w=2 layouts, lh=clear, m4/a2w=opener, pL=cmd, Ei=StorageScope
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return n2w}'
        Replace = 'getDefaultLayouts(){return[...n2w,{id:"default-zen",name:C(3183,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:C(3184,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!1,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_pre35"
        AllowLengthMismatch = $true
    ...
    @{
        ...
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,layer:-24,render:H=>{try{const G=m4(a,u)?_:void 0;return i.createInstance(a2w'
        Replace = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,render:H=>{try{const G=m4(a,u)?_:void 0;return i.createInstance(a2w'
    },
    @{
        Name                = "buildContent_full_pre35"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_pre35"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.7.0-pre.35) ===" "Cyan"
