<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 3.1.0-pre.5 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 3.1.0-pre.5.
    i18n E(). STS (layouts), Eh (clear), eF (layoutEnum), Z2 (settings cmd), wi (StorageScope), opener SR + TTS.
    Zen E(3212), Browser E(3092); avoid E(3091) Layout+Zen. Agent/Editor E(3070)/E(3071). Settings E(3067).
    Opener: getAnchor ()=>O (letter O, not $), layer:-24 removed; createInstance(TTS,...).render(U); tail args M,x.
...
# 3.1.0-pre.5: STS=2 layouts, Eh=clear, eF=layoutEnum, Z2=cmd, TTS=createInstance, wi=StorageScope, openerCheck=SR (anchor getAnchor:()=>O)
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return STS}'
        Replace = 'getDefaultLayouts(){return[...STS,{id:"default-zen",name:E(3212,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:E(3092,null),state:{agentsVisible:!1,chatVisible:!0,editorsVisible:!0,panelVisible:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{},panelMaximized:!1},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_310p5"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "opener_no_layer_310p5"
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,layer:-24,render:U=>{try{const q=SR(a,u)?S:void 0;return i.createInstance(TTS,s,o,a,l,u,d,h,f,p,g,i,_,q,M,x).render(U)}catch(q){throw q}}'
        Replace = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,render:U=>{try{const q=SR(a,u)?S:void 0;return i.createInstance(TTS,s,o,a,l,u,d,h,f,p,g,i,_,q,M,x).render(U)}catch(q){throw q}}'
    },
    @{
        Name                = "buildContent_full_310p5"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_310p5"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (3.1.0-pre.5) ===" "Cyan"
