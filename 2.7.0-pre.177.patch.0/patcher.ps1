<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.7.0-pre.177 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 2.7.0-pre.177.
    i18n E(). mCS (layouts), Ah (clear), KB (layoutEnum), Y2 (cmd), bCS (createInstance), wi (StorageScope), opener bR.
    Zen E(3204), Browser E(3084); avoid E(3083) Layout+Zen. Agent/Editor E(3062)/E(3063). Settings E(3059).
    Opener: getAnchor ()=>O, const q=bR, createInstance bCS (removes layer:-24).
#>
...
# pre.177: mCS=2 layouts, Ah=clear, KB=layoutEnum, Y2=cmd, bCS=createInstance, wi=StorageScope, openerCheck=bR (see Search)
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return mCS}'
        Replace = 'getDefaultLayouts(){return[...mCS,{id:"default-zen",name:E(3204,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:E(3084,null),state:{agentsVisible:!1,chatVisible:!0,editorsVisible:!0,panelVisible:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{},panelMaximized:!1},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_pre177"
        AllowLengthMismatch = $true
    ...
    @{
        ...
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,layer:-24,render:U=>{try{const q=bR(a,u)?w:void 0;return i.createInstance(bCS'
        Replace = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,render:U=>{try{const q=bR(a,u)?w:void 0;return i.createInstance(bCS'
    },
    @{
        Name                = "buildContent_full_pre177"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_pre177"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.7.0-pre.177) ===" "Cyan"
