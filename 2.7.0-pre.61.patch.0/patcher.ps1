<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.7.0-pre.61 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 2.7.0-pre.61.
    pre.61 variables: pUw (2 layouts), ah (clear), RL/AUw (opener), gL (cmd), Ci (StorageScope), Q0 (layoutEnum).
...
# pre.61: pUw=2 layouts, ah=clear, RL/AUw=opener, gL=cmd, _i=StorageScope, Q0=layoutEnum
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return pUw}'
        Replace = 'getDefaultLayouts(){return[...pUw,{id:"default-zen",name:C(3186,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:C(3187,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!1,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"}]}'
    },
    @{
    ...
    @{
        ...
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,layer:-24,render:q=>{try{const G=RL(a,u)?_:void 0;return i.createInstance(AUw'
        Replace = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,render:q=>{try{const G=RL(a,u)?_:void 0;return i.createInstance(AUw'
    },
    @{
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.7.0-pre.61) ===" "Cyan"
