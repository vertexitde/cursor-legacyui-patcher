<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 3.2.0-pre.14 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 3.2.0-pre.14.
    i18n E(). GUS (layouts), Fh (clear), rF (layoutEnum), sB (settings cmd), fi (StorageScope), opener FR + YUS.
    Zen "Zen"; Browser E(2964). Agent/Editor E(2942)/E(2943). Footer E(2939) → patched "Cursor Settings" + keybinding.
    Opener: layer:-24 removed; createInstance(YUS,...).render(U); tail N,x. Differs from 3.2.0-pre.11 (RUS/MUS).
...
# 3.2.0-pre.14: GUS=2 layouts, Fh=clear, rF=layoutEnum, sB=cmd, YUS=createInstance, fi=StorageScope, openerCheck=FR (getAnchor:()=>O)
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return GUS}'
        Replace = 'getDefaultLayouts(){return[...GUS,{id:"default-zen",name:"Zen",state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:E(2964,null),state:{agentsVisible:!1,chatVisible:!0,editorsVisible:!0,panelVisible:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{},panelMaximized:!1},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_320p14"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "opener_no_layer_320p14"
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,layer:-24,render:U=>{try{const q=FR(a,u)?S:void 0;return i.createInstance(YUS,s,o,a,l,u,d,h,f,p,g,i,_,q,N,x).render(U)}catch(q){throw q}}'
        Replace = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,render:U=>{try{const q=FR(a,u)?S:void 0;return i.createInstance(YUS,s,o,a,l,u,d,h,f,p,g,i,_,q,N,x).render(U)}catch(q){throw q}}'
    },
    @{
        Name                = "buildContent_full_320p14"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_320p14"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (3.2.0-pre.14) ===" "Cyan"
