<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 3.2.0-pre.11 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 3.2.0-pre.11.
    i18n E(). RUS (layouts), Fh (clear), rF (layoutEnum), sB (settings cmd), fi (StorageScope), opener FR + MUS.
    Zen "Zen"; Browser E(2964). Agent/Editor E(2942)/E(2943). Footer E(2939) → patched "Cursor Settings" + keybinding.
    Opener: layer:-24 removed; createInstance(MUS,...).render(U); tail N,x. Differs from 3.2.0-pre.6 (y5S/sF/k5S).
...
# 3.2.0-pre.11: RUS=2 layouts, Fh=clear, rF=layoutEnum, sB=cmd, MUS=createInstance, fi=StorageScope, openerCheck=FR (getAnchor:()=>O)
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return RUS}'
        Replace = 'getDefaultLayouts(){return[...RUS,{id:"default-zen",name:"Zen",state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:E(2964,null),state:{agentsVisible:!1,chatVisible:!0,editorsVisible:!0,panelVisible:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{},panelMaximized:!1},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_320p11"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "opener_no_layer_320p11"
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,layer:-24,render:U=>{try{const q=FR(a,u)?S:void 0;return i.createInstance(MUS,s,o,a,l,u,d,h,f,p,g,i,_,q,N,x).render(U)}catch(q){throw q}}'
        Replace = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,render:U=>{try{const q=FR(a,u)?S:void 0;return i.createInstance(MUS,s,o,a,l,u,d,h,f,p,g,i,_,q,N,x).render(U)}catch(q){throw q}}'
    },
    @{
        Name                = "buildContent_full_320p11"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_320p11"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (3.2.0-pre.11) ===" "Cyan"
