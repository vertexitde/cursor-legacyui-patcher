<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 3.2.0-pre.19 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 3.2.0-pre.19.
    i18n E(). D8S (layouts), Bh (clear), sF (layoutEnum), oB (settings cmd), mi (StorageScope), opener LR + B8S.
    Zen "Zen"; Browser E(2964). Agent/Editor E(2942)/E(2943). Footer E(2939) → patched "Cursor Settings" + keybinding.
    Opener: layer:-24 removed; createInstance(B8S,...).render(U); tail N,x. Does not modify nls.messages.json.
...
# 3.2.0-pre.19: D8S=2 layouts, Bh=clear, sF=layoutEnum, oB=cmd, B8S=createInstance, mi=StorageScope, openerCheck=LR (getAnchor:()=>O)
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return D8S}'
        Replace = 'getDefaultLayouts(){return[...D8S,{id:"default-zen",name:"Zen",state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:E(2964,null),state:{agentsVisible:!1,chatVisible:!0,editorsVisible:!0,panelVisible:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{},panelMaximized:!1},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_320p19"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "opener_no_layer_320p19"
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,layer:-24,render:U=>{try{const q=LR(a,u)?S:void 0;return i.createInstance(B8S,s,o,a,l,u,d,h,f,p,g,i,_,q,N,x).render(U)}catch(q){throw q}}'
        Replace = '{getAnchor:()=>O,anchorAlignment:1,anchorPosition:0,render:U=>{try{const q=LR(a,u)?S:void 0;return i.createInstance(B8S,s,o,a,l,u,d,h,f,p,g,i,_,q,N,x).render(U)}catch(q){throw q}}'
    },
    @{
        Name                = "buildContent_full_320p19"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_320p19"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "checksum_fail_notification_noop_320p19"
        AllowLengthMismatch = $true
        Search  = '_showNotification(){const e=this.productService.checksumFailMoreInfoUrl,t=E(14315,null,this.productService.nameShort);e?this.notificationService.prompt(ol.Warning,t,[{label:E(14316,null),run:()=>this.openerService.open(ot.parse(e))},{label:E(14317,null),isSecondary:!0,run:()=>this.storage.set({dontShowPrompt:!0,commit:this.productService.commit})}],{sticky:!0,priority:D1.URGENT}):this.notificationService.notify({severity:ol.Warning,message:t,sticky:!0,priority:D1.URGENT})}'
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (3.2.0-pre.19) ===" "Cyan"
