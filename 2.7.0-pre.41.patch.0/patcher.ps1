<#
.SYNOPSIS
    Cursor Layout Menu Patcher for 2.7.0-pre.41 - Restores the full "Change Layout" menu.

.DESCRIPTION
    Patches workbench.desktop.main.js for Cursor 2.7.0-pre.41.
    Pre.41 variables: X2w (2 layouts), lh (clear), p4/rFw (opener), pL (cmd), Ei (StorageScope), z0 (layoutEnum).
#>
...
# 2.7.0-pre.41: X2w=2 layouts, lh=clear, p4/rFw=opener, pL=cmd, Ei=StorageScope, z0=layoutEnum
$Patches = @(
    @{
        Name                = "getDefaultLayouts_4layouts"
        AllowLengthMismatch = $true
        Search  = 'getDefaultLayouts(){return X2w}'
        Replace = 'getDefaultLayouts(){return[...X2w,{id:"default-zen",name:C(3183,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!0,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"},{id:"default-browser",name:C(3184,null),state:{agentsVisible:!1,chatVisible:!1,editorsVisible:!1,panelVisible:!1,panelMaximized:!1,sidebarVisible:!1,sidebarLocation:"left",partWidths:{}},type:"default"}]}'
    },
    @{
        Name                = "renderModeGrid_pre41"
        AllowLengthMismatch = $true
    ...
    @{
        ...
        AllowLengthMismatch = $true
        Search  = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,layer:-24,render:q=>{try{const G=p4(a,u)?_:void 0;return i.createInstance(rFw'
        Replace = '{getAnchor:()=>$,anchorAlignment:1,anchorPosition:0,render:q=>{try{const G=p4(a,u)?_:void 0;return i.createInstance(rFw'
    },
    @{
        Name                = "buildContent_full_pre41"
        AllowLengthMismatch = $true
    ...
    @{
        Name                = "appendCursorSettingsButton_keybinding_pre41"
        AllowLengthMismatch = $true
...
function Invoke-Patch {
    Write-ColorOutput "=== Cursor Layout Patcher (2.7.0-pre.41) ===" "Cyan"
